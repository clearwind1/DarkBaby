...
module GameUtil
{
    ...
    {
        private curScene:egret.DisplayObjectContainer = null;
        private nextScene:egret.DisplayObjectContainer = null;
        private MainStage:egret.Stage = null;
        ...
        public getMainStage():egret.Stage{
         ...
         */
        public runscene(scene:egret.DisplayObjectContainer,transtype:number=GameConfig.NullAction,duration:number=800):void
        {
